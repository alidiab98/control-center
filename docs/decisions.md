...
| `getAutomationsToday()` returns oldest first                                             | It reads as a timeline. The mockup's own order is neither chronological nor reverse, so it was treated as arbitrary.                                                                                                         |
